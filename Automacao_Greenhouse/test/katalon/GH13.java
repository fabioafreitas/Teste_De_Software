...
public class GH13 {
  ...
  @Test
  public void testGH13() throws Exception {
    ...
    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Jurídica'])[1]/following::input[4]")).sendKeys("1112223334");
    ...
    Thread.sleep(1000); // espera a rua ser preenchida automaticamente
    ...
    assertEquals("CPF invalido", closeAlertAndGetItsText());
  }
