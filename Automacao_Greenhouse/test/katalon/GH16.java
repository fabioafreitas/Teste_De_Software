...
public class GH16 {
  ...
  @Test
  public void testGH16() throws Exception {
    ...
    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Jurídica'])[1]/following::input[1]")).sendKeys("teste@gmail");
    ...
    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Jurídica'])[1]/following::input[4]")).sendKeys("11122233344");
    ...
    assertEquals("EMAIL inválido", closeAlertAndGetItsText());
  }
