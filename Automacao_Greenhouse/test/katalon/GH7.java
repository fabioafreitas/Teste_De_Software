...
public class GH7 {
  ...
  public void testGH7() throws Exception {
    ...
    driver.findElement(By.id("defaultLoginFormEmail")).sendKeys("exemplo2_de_email_no_limite_51_caracteres@email.com");
    ...
    for (int second = 0;; second++) {
    	...
    	try { if (driver.findElement(By.cssSelector("BODY")).getText().matches("^[\\s\\S]*EMAIL inválido[\\s\\S]*$")) break; } catch (Exception e) {}
    	Thread.sleep(1000);
    }
